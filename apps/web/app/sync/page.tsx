...
import { getMendeleyOverview, getSchedulerStatus } from "@/app/actions";
import { MendeleyPanel } from "@/components/sync/mendeley-panel";

export const dynamic = "force-dynamic";

export default async function SyncPage() {
  const [overview, sched] = await Promise.all([getMendeleyOverview(), getSchedulerStatus()]);
  return (
    <main className="mx-auto max-w-2xl px-6 py-10">
      ...
      <MendeleyPanel initial={overview} sched={sched} />
    </main>
  );
}
